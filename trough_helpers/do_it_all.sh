...
##########################
 ...
 do
  ...
  do
    ...
    then
      echo $helpers/troughfinder $base/trough_${theta}_count.fits* $PREFIX/$COOKIEMASKPREFIX${i}_${theta}.fits.gz ${count_maxmaskfrac} $base/trough_${theta}_$i $countpercentiles
      $helpers/troughfinder $base/trough_${theta}_count.fits* $PREFIX/$COOKIEMASKPREFIX${i}_${theta}.fits.gz ${count_maxmaskfrac} \
...
##########################
 ...
 do
  ...
  do
    ...
    then
      echo $helpers/pofn_bernoulli $base/trough_${theta}_count.fits* ${PREFIX}/$COOKIEMASKPREFIX${i}_${theta}.fits.gz ${count_maxmaskfrac} 
      $helpers/pofn_bernoulli $base/trough_${theta}_count.fits* ${PREFIX}/$COOKIEMASKPREFIX${i}_${theta}.fits.gz \
 ...
 do
  ...
  do
   ...
   do
      ...
      then
        echo python ${PREFIX}/measure_gammat.py $base/trough_${theta}_${i}_${s}.fits* $base/kappa-gamma-${m}.fits* $PREFIX/$COOKIEMASKPREFIX${i}.fits.gz $base/gammat_${m}_${theta}_${s}_$i.tab
        python ${PREFIX}/measure_gammat.py $base/trough_${theta}_${i}_${s}.fits* $base/$RUN/kappa-gamma-${m}.fits* $PREFIX/$COOKIEMASKPREFIX${i}.fits.gz $base/gammat_${m}_${theta}_${s}_$i.tab &> $base/gammat_${m}_${theta}_${s}_${i}.log
      fi
    done
   done
  done
 ...
 echo "(2.5) measure shape noise shear"
  ...
  do
   ...
   do
      ...
      then
        echo python ${PREFIX}/measure_gammat_shapenoise.py $base/trough_${theta}_${i}_${s}.fits* 0.037 ${PREFIX}/$COOKIEMASKPREFIX${i}.fits.gz $base/gammat_shapenoise_${theta}_${s}_$i.tab ${1}$i
